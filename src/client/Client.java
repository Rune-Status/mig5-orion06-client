...
public class Client extends RSApplet {
	...
	public static final int CLIENT_VERSION = 317;//increase this, when client update is reguired
	public boolean developMode = false;//show ids for stuff etc. (admin accounts)
	static boolean isEasyAeonClient = false;//changes port to connect to other server
	boolean isLocalClient = false;//connects to localhost if true!!!
...
//		}
   ...
   public static final String NAME = "Rune06";
...
//      sprite.drawSprite(382 - sprite.myWidth / 2 - 128, 18);
   ...
   int previousBankScrollPosition = 0;
	...
	void searchBank(){
		...
		RSInterface.interfaceCache[5383].message = "Bank of Rune06 (search: '"+searchingBank+"')";
		RSInterface.interfaceCache[5385].scrollPosition = 0;
		if(searchingBank == ""){
			RSInterface.interfaceCache[5383].message = "Bank of Rune06 (no search entered)";
			RSInterface.interfaceCache[18787].message = "No search term entered!";
		}else{
			//RSInterface.interfaceCache[5383].message = "Bank of Rune06 (search: '"+TextClass.fixName(searchingBank)+"')";
...
//            	this.pushMessage(message, 98, icon+""+"["+this.globalNameColor+"Global"+this.blackColor+"] "+name);
   ...
   public Client() {
	  server = isLocalClient ? "78.47.61.8" : "78.47.61.8";
	  serverIp2 = "78.47.61.8";
	  cButtonHPos = -1;
		cButtonCPos = 0;
		chatTypeView = 0;
